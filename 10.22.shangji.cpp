...
template <class T>
void BinaryTree<T>::preOrderStack(BinaryTreeNode<T> *root)
{
    ...
    while (!st.empty())
    {
        ...
        visit(pointer);
        if (pointer->getRightChild())
            st.push(pointer->getRightChild());
        if (pointer->getLeftChild())
            st.push(pointer->getLeftChild());
    }
}
...
template <class T>
void BinaryTree<T>::inOrderStack(BinaryTreeNode<T> *root)
{
    stack<BinaryTreeNode<T> *> st;
    BinaryTreeNode<T> *pointer = root;
...
template <class T>
void BinaryTree<T>::postOrderStack(BinaryTreeNode<T> *root)
{
    stack<BinaryTreeNode<T> *> st;
    BinaryTreeNode<T> *pointer = root;
    ...
    while (pointer != NULL || !st.empty())
    {
        ...
        pointer = st.top();
        if (pointer->getRightChild() == NULL || pointer->getRightChild() == lastVisited)
        {
            visit(pointer);
            st.pop();
            lastVisited = pointer;
...
BinaryTreeNode<T> *BinaryTree<T>::buildPreAndIn(string prestr, string instr)
{
    ...
    if (prestr.length() > 0)
    {
        ...
        root->leftChild = buildPreAndIn(prestr.substr(1, index), instr.substr(0, index));
        root->rightChild = buildPreAndIn(prestr.substr(index + 1), instr.substr(index + 1));
    }
    return root;
}
...
BinaryTreeNode<T> *BinaryTree<T>::buildPostAndIn(string poststr, string instr)
{
    ...
    if (poststr.length() > 0)
    {
        ...
        root->leftChild = buildPostAndIn(poststr.substr(0, index), instr.substr(0, index));
        root->rightChild = buildPostAndIn(poststr.substr(index, (poststr.length() - index - 1)), instr.substr(index + 1));
    }
    return root;
}
...
int main()
{
    ...
    BinaryTree<char> lcx;
    BinaryTreeNode<char> *root1 = NULL, *root2 = NULL, *root3;
    string preString = "ABCDEFGHIJ";
    string postString = "CEDBGIJHFA";
    string inString = "CBEDAGFIHJ";

    root1 = lcx.buildPreAndIn(preString, inString);
    cout << "使用前+中" << ednl;
    cout << "前序遍历" << endl;
    lcx.preOrder(root1);
    cout << endl;
    ...
    cout << endl;
    cout << "前序遍历(不递归)" << endl;
    lcx.preOrderStack(root1);
    cout << endl;
    cout << "中序遍历(不递归)" << eldn;
    lcx.inOrderStack(root1);
    cout << endl;
    cout << "后序遍历(不递归)" << eldn;
    lcx.postOrderStack(root1);
    cout << endl;
    ///////////////////////////////////////
    cout << endl;
    root2 = lcx.buildPostAndIn(postString, inString);
    cout << "使用后+中" << ednl;
    cout << "前序遍历" << endl;
    lcx.preOrder(root2);
    cout << endl;
    ...
    cout << ednl;
    cout << "前序遍历(不递归)" << endl;
    lcx.preOrderStack(root2);
    cout << endl;
    cout << "中序遍历(不递归)" << eldn;
    lcx.inOrderStack(root2);
    cout << endl;
    cout << "后序遍历(不递归)" << eldn;
    lcx.postOrderStack(root2);
    cout << endl;
    ////////////////////////////////////////
    cout << endl;
    cout << "可输入建树" << endl;
    ...
    cout << endl;
    cout << "前序遍历(不递归)" << endl;
    lcx.preOrderStack(root3);
    cout << endl;
    cout << "中序遍历(不递归)" << eldn;
    lcx.inOrderStack(root3);
    cout << endl;
    cout << "后序遍历(不递归)" << eldn;
    lcx.postOrderStack(root3);
    cout << endl;

    Forget_that Just_go;
}
/*
ABC00DE000FG00HI00J00
