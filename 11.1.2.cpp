...
ll crossMul(point a1, point a2, point b1, point b2)
{
...
int main()
{
    ...
    _rep(i, 1, n)
    {
        cin >> arr[i * 3 - 2].x >> arr[i * 3 - 2].y;
        cin >> arr[i * 3 - 1].x >> arr[i * 3 - 1].y;
        cin >> arr[i * 3].x >> arr[i * 3].y;
    }
    ...
    while (asd--)
    {
        ...
        _rep(i, 1, n)
        {
            ll a1 = crossMul(arr[i * 3 - 2], arr[i * 3 - 1], arr[i * 3 - 2], temp);
            ll a2 = crossMul(arr[i * 3 - 1], arr[i * 3], arr[i * 3 - 1], temp);
            ll a3 = crossMul(arr[i * 3], arr[i * 3 - 2], arr[i * 3], temp);
