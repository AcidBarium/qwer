...
int main()
{
    ...
    for (int ti = 0; ti < 500; ti++)
    {
        ...
        _rep(i, 1, n) _rep(j, 1, m) arr[i][j] = 0;
        _rep(i, 1, n) _rep(j, 1, m) brr[i][j] = 0;
        int cnt = rand() % (n * m) + 1;
        // int cnt = 10;
